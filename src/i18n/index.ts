...
const zh = {
  ...
  roomNumberLabel: '房间号ID', hostLabel: '主持人',
  watchUrl: '观看地址',
  noWatchUrl: '暂无观看地址', watchUrlCopied: '已复制观看地址',
  copyFailed: '复制失败，请手动复制', copyLink: '复制链接',
  // BottomBar
...
const en: typeof zh = {
  ...
  roomNumberLabel: 'Room ID', hostLabel: 'Host',
  watchUrl: 'Watch URL',
  noWatchUrl: 'No watch URL yet', watchUrlCopied: 'Watch URL copied',
  copyFailed: 'Copy failed, please copy manually', copyLink: 'Copy',
